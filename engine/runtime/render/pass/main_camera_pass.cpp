...
//                             m_offscreen_pipeline_layout, 0, 1,
//                             &m_offscreen_set, 1, &dy_offsets);

//     VkDeviceSize offsets[] = {0};

//     for (const auto& [k, v] : m_resources->GetMeshesObject()) {
//       vkCmdBindVertexBuffers(command_buffer, 0, 1, &v.mesh_vert_buf,
//       offsets); vkCmdBindIndexBuffer(command_buffer, v.mesh_indices_buf, 0,
...
//     vkCmdBindDescriptorSets(command_buffer, VK_PIPELINE_BIND_POINT_GRAPHICS,
//                             m_composite_pipeline_layout, 0,
//                             bound_sets.size(), bound_sets.data(), 1,
//                             &dy_offsets);
...
//     auto input_bindings =
//     RenderMeshVertexBasic::GetInputBindingDescription(); auto
//     input_attributes = RenderMeshVertexBasic::GetAttributeDescription();
...
//     terrain_texture_info.imageLayout =
//     VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL; terrain_texture_info.imageView
//     =
...
//     vkUpdateDescriptorSets(m_rhi->m_device, writers.size(), writers.data(),
//     0,
//                            nullptr);
//   }
...
//     dyset_writers[0].descriptorType =
...
//     gPositionInfo.sampler =
//     m_resources->GetGBufferResources().gBufferSampler;
...
//       // position-ws
//       gPositionInfo.imageView =
//       m_resources->GetGBufferObject(i).gPositionView;
